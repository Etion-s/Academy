...
public class MainQuickStart {
	...
	public static void main(String[] args) {
		...
		/*
		 * WriteArticleService writeArticleService = ctx.getBean("writeArticleService",
		 * WriteArticleService.class); writeArticleService.write(new
		 * NewArticleRequest("writer", "title", "content"));
		 */
		...
		/*
		 * UpdateInfo updateInfo = new UpdateInfo(); updateInfo.setNewName("새이름");
